...
class Net(nn.Module):# FCN Net class for semantic segmentation init generate net layers and forward run the inference
        def __init__(self,NumClasses,PreTrainedModelPath="",UseGPU=False,UpdateEncoderBatchNormStatistics=True): # prepare net layers and load Load pretrained encoder weights
