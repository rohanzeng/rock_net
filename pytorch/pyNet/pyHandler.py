...
class rockHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        self.model = models.segmentation.fcn_resnet50(pretrained=False,progress=True,num_classes=2,aux_loss=None)
    ...
    def inference(self, tensors):
        ...
        output = [F.softmax(self.model(x)['out'], dim = 1) for x in tensors]
        return output
