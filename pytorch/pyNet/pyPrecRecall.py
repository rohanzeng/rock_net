...
def run():
    ...
    '''
    fig, ax = plt.subplots(figsize=(6,6))
    ax.plot(probability_thresholds, rScoreLR, label = "Logistic Regression")
    ax.plot(probability_thresholds, rScoreL2, label = "L2 Logistic Regression")
    ax.set_xlabel("Thresholds")
    ax.set_ylabel("Recall")
    ax.legen(loc='center left')

    fig.savefig('./outputs/recallCurve_'+modelTest[:-6]+'.png')
