...
#Used to train network using a classification network first, then selecting weights to run through the final network
#Final result should be trained weights for different classes
